...
namespace CallCenter.Multimedia
{
    public class ManualSignalling : Signalling
    {
        ...
        public ManualSignalling(string serverUrl, string name, string sessionId, Function1<PeerClient, Connection> createConnection, Action2<string, string> onReceivedText)
