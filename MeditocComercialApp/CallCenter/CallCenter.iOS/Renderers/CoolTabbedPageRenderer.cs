...
[assembly: ExportRenderer(typeof(CoolTabbedPage), typeof(CoolTabbedPageRenderer))]
namespace CallCenter.iOS.Renderers
{
    public class CoolTabbedPageRenderer: TabbedRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            base.ViewWillAppear(animated);

            if (((CoolTabbedPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            //backBtnImage.ApplyTintColor(UIColor.FromRGB(90, 183, 204));
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((ICoolContentPage)Element)?.CustomBackButtonAction != null)
                {
                    ((ICoolContentPage)Element)?.CustomBackButtonAction.Invoke();
                }
            };
