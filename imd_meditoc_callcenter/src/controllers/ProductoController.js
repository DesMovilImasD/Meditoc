...
class ProductoController {
    ...
    async funcSaveProducto(entProducto) {
        ...
        try {
            const apiResponse = await fetch(`${serverMain}${this.apiCreateProducto}`, {
                method: "POST",
    ...
    async funcGetProductos(iIdProducto = null) {
        ...
        try {
            const apiResponse = await fetch(`${serverMain}${this.apiObtenerProductos}?iIdProducto=${iIdProducto}`, {
