...
class ReportesController {
    ...
    async funcObtenerReporteDoctores(
        ...
        try {
            ...
            response.Code = -1;
            response.Message = "Ocurrió un error al intentar obtener la información de los doctores";
        }
        return response;
    }
    ...
    async funcObtenerReporteVentas(
        ...
        try {
            ...
            response.Code = -1;
            response.Message = "Ocurrió un error al intentar obtener la información de ventas";
        }
        return response;
    }
