namespace chat.websync {
    export class App {
        ...
        public joinAsync(incomingMessage: (name: string, message: string, sending: false, recived: true) => void, peerLeft: (name: string) => void, peerJoined: (name: string) => void): fm.icelink.Future<Object> {
        ...
        private autoSignalling(incomingMessage: (name: string, message: string, sending: false, recived: true) => void, peerLeft: (name: string) => void, peerJoined: (name: string) => void): Signalling {
            var self = this;
        ...
        private manualSignalling(incomingMessage: (name: string, message: string, sending: false, recived: true) => void, peerLeft: (name: string) => void, peerJoined: (name: string) => void): Signalling {
            var self = this;
